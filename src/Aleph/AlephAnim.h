...
class AlephAnim : public Animation {
    ...
    */
    ...
    KeyFrameTrack pupilH = KeyFrameTrack(10, 0.0f, 1.0f, 10, KeyFrameTrack::Cosine); //horiontal
    KeyFrameTrack pupilV = KeyFrameTrack(10, 0.0f, 1.0f, 10, KeyFrameTrack::Cosine); //vertical
    KeyFrameTrack pupilD = KeyFrameTrack(10, 0.0f, 1.0f, 10, KeyFrameTrack::Cosine); //dilation
    KeyFrameTrack pupilS = KeyFrameTrack(10, 0.0f, 1.0f, 10, KeyFrameTrack::Cosine); //size
...
*/
    ...
    void Sad(){
        Ears.emotion(sStepper::Modes::sad, 100);
