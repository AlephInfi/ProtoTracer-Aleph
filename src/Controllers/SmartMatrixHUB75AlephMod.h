...
public:
    ...
    Vector3D GetRGB(uint16_t i){
        return Vector3D(camMain.GetPixelGroup()->GetPixel(i)->Color.R, camMain.GetPixelGroup()->GetPixel(i)->Color.G, camMain.GetPixelGroup()->GetPixel(i)->Color.B);
    }
